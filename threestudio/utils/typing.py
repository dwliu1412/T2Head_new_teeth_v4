...
try:
    ...
    # Runtime annotation checks are optional; static tensor annotations remain
    # useful in minimal inference/fine-tuning environments without typeguard.
    def typechecker(function=None, **_kwargs):
        if function is None:
