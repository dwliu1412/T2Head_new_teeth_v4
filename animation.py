...
if __name__ == '__main__':
    ...
    talkshow_path = 'talkshow/ExpressiveWholeBodyDatasetReleaseV1.0/chemistry/2nd_Order_Rate_Laws-6BZb96mqmbg.mp4/68891-00_01_40-00_01_46/68891-00_01_40-00_01_46.pkl'
    # path to save folder. e.g. save_path = "Ion_Energy_Levels_Quiz-V-FBHIdXk20.mkv/67729-00_03_14-00_03_19/67729-00_03_14-00_03_19.pkl"
    save_path = 'outputs/render/ours'
    # path to headstudio file, e.g. ply_path = "/path/to/a_DSLR_portrait_of_Geralt_in_The_Witcher@20240114-040728/save/last.ply"
    ply_path = 'outputs/headstudio/20250807-070243Messi/optim/ckpt/epoch_0091.ply'
